...
- CSS for displaying buttons in a four grid template columns and added `y `scrolling, and box shadowing
...
- generating React project using [Vite](https://vitejs.dev/guide/)
